          ...
          <footer className="text-white md:flex flex-col md:mt-14">
            ...
            <div className="bg-secondary w-full pt-5 pb-2 px-4 md:px-0">
              <div className="container mx-auto my-6">
                <div className="md:border-b md:flex justify-between mb-5 pb-10">
                  <div className="md:w-1/5">
                    ...
                    <div className="md:hidden border-b border-blue md:border-0">
                  ...
                  <div className="flex-grow border-b border-blue md:border-0">
                  ...
                  <div className="md:text-right text-sm leading-7">
                    ...
                    <div className=" border-b border-blue md:border-0">
                      График работы <br /> с 10-00 до 23-00 Ежедневно
                    </div>
                    <div className="mt-4  border-b border-blue md:border-0">
