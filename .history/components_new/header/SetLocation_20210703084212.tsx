...
const SetLocation: FC = () => {
  ...
  return (
    <>
      <button
        className="bg-yellow cursor-pointer md:flex items-center justify-center rounded-full text-white w-1/3 h-[36px] outline-none focus:outline-none hidden md:block"
        onClick={() => {
          setOpen(true)
        }}
      >
