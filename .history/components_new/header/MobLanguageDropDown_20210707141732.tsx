...
const LanguageDropDown: FC = () => {
  ...
  return (
    <>
      <a
        className="bg-white rounded-2xl focus:outline-none font-medium inline-flex justify-center outline-none px-4 py-2 text-secondary text-sm no-underline w-16 h-7"
