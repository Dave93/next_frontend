  ...
  return (
    <>
      ...
      {!user && (
        <>
          <button
            className="md:bg-gray-200 bg-yellow px-8 py-1 rounded-full text-secondary outline-none focus:outline-none my-5 md:my-0 ml-4 md:ml-0 font-bold md:font-thin"
            onClick={openModal}
          >
            {tr('signIn')}
          </button>
