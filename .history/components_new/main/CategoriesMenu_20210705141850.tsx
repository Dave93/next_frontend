...
const CategoriesMenu: FC<{ categories: LinkItem[] }> = ({
  ...
  return (
    ...
    >
      <div className="container flex items-center m-auto overflow-x-scroll md:overflow-x-hidden">
        {fixed && (
        ...
        <div
          className={`${
            fixed
              ...
              : 'bg-white flex h-14 items-center justify-between md:px-36 rounded-xl shadow-lg md:w-full'
          } `}
        >
