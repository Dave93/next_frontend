    ...
    <>
      ...
      <div className="mb-10">
        ...
        <div className="border-yellow rounded-3xl grid grid-cols-2">
          <div  className="flex">
            <div className="text-green-500">Зона А:</div> При доставке по Ташкенту
            минимальная сумма заказа составляет 60 000 сум, среднее время
            доставки 40 минут
          </div>
          <div className="flex">
            <div className="text-yellow">Зона B:</div> При доставке по ТКАД
