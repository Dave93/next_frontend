    ...
    <>
      ...
      <div className="mb-10">
        ...
        <Image
          ...
          height={1075}
        />
        <div className="border-yellow rounded-3xl grid grid-cols-2">
          <div>
            Зона А: При доставке по Ташкенту минимальная сумма заказа составляет
            60 000 сум, среднее время доставки 40 минут
          </div>
          <div>
            Зона B: При доставке по ТКАД минимальная сумма заказа составляет 100
            000 сум, среднее время доставки – 60 минут
          </div>
        </div>
      </div>
      <div className="mb-10">
