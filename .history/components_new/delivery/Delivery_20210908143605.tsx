        ...
        <div className="md:grid grid-cols-3 mt-10">
          <div className="flex">
            ...
            <div className="md:ml-4 md:w-56">
              <div className="md:text-xl ">Оплата наличными</div>
              <div className="text-xs text-gray-400">
          ...
          <div className="flex">
            ...
            <div className="ml-4  md:w-56">
              <div className="md:text-xl">Оплата картой</div>
              <div className="text-xs text-gray-400">
          ...
          <div className="flex">
            ...
            <div className="ml-4 md:w-56">
              <div className="md:text-xl">Онлайн оплата</div>
              <div className="text-xs text-gray-400">
                Для выбора оплаты товара картой при получении, на странице
