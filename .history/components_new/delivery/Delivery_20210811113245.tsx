    ...
    <>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-4 mt-10">
          ...
          <div className="flex">
            <div>
              <img src="/confirmOrder.png" alt="" width="60px" height="60px"/>
            </div>
            <div className="ml-3  w-7/12">
      ...
      <div className="mb-10">
        ...
        <Image
          ...
          height={1075}
        />
        <div className="border border-yellow flex justify-between mt-2 py-5 px-8 rounded-xl">
          <div className="flex">
