    ...
    <>
      ...
      <div className="mb-10">
        ...
        <Image
          ...
          height={1075}
        />
        <div className="border border-yellow rounded-xl grid grid-cols-2 p-5 mt-2">
          <div className="flex">
            <div>
              <img src="zoneA.png" />
            </div>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-4 mt-10">
          <div className="flex">
            ...
            <div className="ml-3 w-7/12">
              <div className="leading-6 text-xl ">Оплата наличными</div>
              <div className="text-xs text-gray-400">
          ...
          <div className="flex">
            ...
            <div className="ml-3  w-7/12">
              <div className="leading-6 text-xl">Оплата картой</div>
              <div className="text-xs text-gray-400">
          ...
          <div className="flex">
            ...
            <div className="ml-3 w-7/12">
              <div className="leading-6 text-xl">Онлайн оплата</div>
              <div className="text-xs text-gray-400">
                Для выбора оплаты товара картой при получении, на странице
