      ...
      <div className="w-full bg-white mb-5 rounded-2xl p-10">
        <div className="flex">
          ...
          <label className="mr-8 cursor-pointer text-gray-400">
            <input type="checkbox" className={`${checked ? 'text-yellow' : 'text-gray-200'} 'form-checkbox'`} ref={setChecked(ass)}/> SMS
          </label>
          <label className="cursor-pointer text-gray-400">
            <input type="checkbox" className="text-yellow form-checkbox" />
            E-mail рассылка
          </label>
        </div>
      </div>
