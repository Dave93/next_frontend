...
🅿️ парковка`,
  ...
  return (
    <>
      ...
      {/* time of delivery */}
      <div className="w-full bg-white my-5 rounded-2xl p-10">
        <div className="text-lg mb-5 font-bold">
        ...
        <div>
          <button
            className={`${
              deliveryActive !== 1 ? 'text-gray-400' : 'bg-yellow text-white'
          ...
          <button
            className={`${
              deliveryActive !== 2 ? 'text-gray-400' : 'bg-yellow text-white'
        ...
        <Menu>
          <Menu.Button className="flex-1 font-bold  rounded-full outline-none focus:outline-none  h-11 md:w-44">
            More
          </Menu.Button>
          <Menu.Items>
            <Menu.Item>
