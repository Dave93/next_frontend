    ...
    <div>
      <div className="p-10 rounded-2xl text-xl mt-5 bg-white">
        <div className=" flex justify-between">
          ...
          <div>
            <div className="text-base text-gray-500 mb-2 text-right">Время заказа</div>
        ...
        <div className="flex items-center justify-between mb-10 ">
          <div className="h-24 relative flex flex-col items-center top-5 w-12">
            ...
            <div className="border-2  h-12 rounded-full w-12">
              <img src="/assets/status.png" />
            </div>
          </div>
          <div className="border-2 border-yellow rounded-full w-52"></div>
          <div className="h-24 relative flex flex-col items-center top-5 w-12">
            <div className="absolute bottom-0 leading-4 mt-2 text-base text-center text-yellow">
              Обработка заказа
            </div>
