...
import React, { Fragment, useState, useMemo, FC, memo, useEffect } from 'react'
...
🅿️ парковка`,
  ...
  const checkboxValueChange = (e: any) => {
    ...
    <>
      ...
      <div className="w-full bg-white mb-5 rounded-2xl p-10">
        <div className="flex items-center">
          ...
          <label className="mr-8 cursor-pointer text-gray-400">
            <input
              type="checkbox"
              className={` ${
                checkboxChecked && 'text-yellow'
              } 'form-checkbox h-5 w-5 text-gray-400 rounded-md'`}
          ...
          <label className="cursor-pointer text-gray-400">
            <input
              type="checkbox"
              className="text-yellow form-checkbox h-5 w-5 rounded-md"
              onChange={checkboxValueChange}
            />
            E-mail рассылка
          </label>
