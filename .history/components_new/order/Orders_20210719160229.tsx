    ...
    <>
      ...
      <div className="w-full bg-white mb-5 rounded-2xl p-10">
        ...
        <div className="flex justify-between mt-8">
          <div className="bg-gray-200 flex h-12 items-center justify-between px-12 rounded-full w-80">
            <img src="/left.png" />
            <button className="text-xl text-gray-400">
              Вернуться в корзину
            </button>
          </div>
          <div className="flex h-10 items-center justify-between px-12 rounded-full w-80 bg-yellow">
