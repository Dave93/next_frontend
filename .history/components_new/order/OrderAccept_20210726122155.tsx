...
const OrderAccept: FC = () => {
  ...
  return (
    <div>
      <div className="p-10 rounded-2xl text-xl mt-5 bg-white flex justify-between">
        <div>
        ...
        <div className="">
          <div className="w-12 h-12 border rounded-full text-yellow"></div>
          <div className="w-"></div>
          <div className="w-12 h-12 border rounded-full text-yellow"></div>
          <div className="w-"></div>
          <div className="w-12 h-12 border rounded-full text-yellow"></div>
      ...
      <div className="p-10 rounded-2xl text-xl mt-5 bg-white">
        ...
        <div className="flex justify-between mt-8">
          ...
          <button className="text-xl text-white bg-yellow flex h-12 items-center justify-evenly rounded-full w-80" onClick={() => router.push('/')}>
            <div>На главную</div>
            <img src="/right.png" />
          </button>
        </div>
