...
🅿️ парковка`,
  ...
  return (
    <>
      <div className="bg-white flex rounded-full w-full h-11 items-center">
        <button
          className={`${
            tabIndex == 1
              ? 'bg-yellow text-white'
              : ' text-gray-400 bg-gray-200'
          } flex-1 font-bold  text-[16px] rounded-full outline-none focus:outline-none  h-11 my-10`}
        ...
        <button
          className={`${
            tabIndex == 2
              ? 'bg-yellow text-white'
              : ' text-gray-400 bg-gray-200'
          } flex-1 font-bold  text-[16px] rounded-full outline-none focus:outline-none  h-11 m-10`}
