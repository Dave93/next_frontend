...
🅿️ парковка`,
  ...
  return (
    <>
      <div className="bg-white flex rounded-2xl w-full items-center p-10 h-32">
        <div className="bg-gray-400 flex  w-full">
          <button
            className={`${
              tabIndex == 1 ? 'bg-yellow text-white' : ' text-gray-40'
