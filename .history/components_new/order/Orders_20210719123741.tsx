...
🅿️ парковка`,
  ...
  return (
    <>
      ...
      {/* order list */}
      <div class="flex items-center justify-between border-b mt-4 pb-4" id="headlessui-disclosure-panel-3"><div class="flex items-center"><img class="w-24" src="/pizza_img.png"><div class="ml-5"><div class="text-xl font-bold">Пепперони</div><div class="text-gray-400 text-xs">Средняя 32 см, Традиционное тесто</div></div></div><div>108 000 сум</div></div>
    </>
  )
}
