  ...
  return (
    <div className="w-full max-w-xs">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mt-10">
          <label className="text-sm text-gray-100 mb-2 block">
          ...
          <div className="relative">
            ...
            {authName && (
              <button
                className="absolute focus:outline-none inset-y-0 outline-none right-4 text-gray-100"
                onClick={() => resetField('name')}
              >
                <XIcon className="cursor-pointer h-5 text-gray-100 w-5" />
              </button>
            )}
          </div>
        </div>
