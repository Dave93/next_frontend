    ...
    <>
      ...
      <div className="w-full bg-white mb-5 rounded-2xl p-10">
        ...
        <div className={openTab === 2 ? 'block' : 'hidden'} id="link2">
          <input type="radio" value="uzcard" checked={payType === 'uzcard'} onChange={onValueChange}/>
          <input type="radio" value="visa"  onChange={onValueChange}/>
          <input type="radio" value="humo"  onChange={onValueChange}/>
          <input type="radio" value="mastercard"  onChange={onValueChange}/>
        </div>
