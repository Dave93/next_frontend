    ...
    <div>
      <div className="p-10 rounded-2xl text-xl mt-5 bg-white">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div class="h-24 relative top-10 w-12"><div class="border h-12 rounded-full w-12"><img src="/assets/status.png"></div><div class="absolute bottom-0 leading-4 mt-2 text-base text-center text-yellow">Обработка заказа</div></div>
