    ...
    <>
      ...
      {items.map((value, key) => (
        <div key={key} className="mb-5">
          <div className="border flex justify-between p-10 rounded-2xl text-xl">
            <div className="text-white text-sm rounded-full bg-red-600 w-20 align-items-center text-center">
              {value.type}
            </div>
            <div>{value.address}</div>
            <div className="text-gray-400 text-sm rounded-full bg-gray-100 align-items-center text-center w-28">
