                ...
                <Disclosure.Panel className="">
                  <div className="border-t mt-7">
                    <div className="mt-7">
                      <div className="flex justify-between">
                        <div className="w-80">
                          <label className="text-sm text-gray-400 mb-1">Улица</label>
                          <input
                            type="text"
                            {...register('address')}
                        ...
                        <div className="w-80">
                          <label className="text-sm text-gray-400 mb-1">Дом</label>
                          <input
                            type="text"
                            {...register('address')}
                            className="bg-gray-100 px-8 py-2 rounded-full outline-none focus:outline-none w-full"
                      ...
                      <div className="flex justify-between mt-7">
                        <div className="w-80">
                          <label className="text-sm text-gray-400 mb-1">Этаж</label>
                          <input
                            type="text"
                            {...register('address')}
                            className="bg-gray-100 px-8 py-2 rounded-full outline-none focus:outline-none w-full"
