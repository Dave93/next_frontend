            ...
            {({ open }) => (
              <>
                ...
                <div className="flex items-center justify-between border-b mt-4 pb-4">
                  <div className="flex items-center justify-between border-b mt-4 pb-4">Сумма: {item.totalPrice}</div>
                  <div className="flex items-center justify-between border-b mt-4 pb-4">Адрес: {item.address}</div>
                  <div className="flex items-center justify-between border-b mt-4 pb-4">Время заказа: {item.date}</div>
                </div>
