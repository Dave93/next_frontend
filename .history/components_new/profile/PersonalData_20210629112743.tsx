        ...
        <div className="mt-10">
          ...
          <div className="relative">
            <input
              type="text"
              {...register('name')}
              className="border focus:outline-none outline-none px-6 py-3 rounded-full text-sm w-full"
            />
            {authName && (
              <button
        ...
        <div className="mt-10">
          ...
          <div className="relative">
            <input
              ...
              className="borde focus:outline-none outline-none px-6 py-3 rounded-full text-sm w-full"
            />
            {authPhone && (
              <button
                className="absolute focus:outline-none inset-y-0 outline-none right-4 text-gray-400"
