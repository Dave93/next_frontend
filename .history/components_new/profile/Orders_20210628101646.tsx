    ...
    <div>
      ...
      <div className="border h-56  p-10 rounded-2xl text-xl">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="border flex focus:outline-none items-center justify-center px-3 py-3 rounded-sm w-64 text-lg h-10 mt-8 rounded-3xl">
                <span>Детали заказа</span>
                <ChevronUpIcon
                  className={`${
                    open ? 'transform rotate-180' : ''
                  } w-5 h-6 text-purple-500`}
                />
              </Disclosure.Button>
