      ...
      <div className="border h-56  p-10 rounded-2xl text-xl">
        ...
        <div className="flex justify-between">
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button className="border flex focus:outline-none items-center justify-end px-3 py-3 w-64 text-lg h-10 mt-8 rounded-3xl bg-gray-100 text-gray-400">
          ...
          <Disclosure>
            <Disclosure.Button className="border flex focus:outline-none items-center justify-end px-3 py-3 w-64 text-lg h-10 mt-8 rounded-3xl gb-yellow text-gray-400">
