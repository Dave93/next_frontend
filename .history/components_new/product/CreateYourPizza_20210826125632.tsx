      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform grid grid-cols-3 gap-4 bg-white shadow-xl rounded-2xl">
                <div>1</div>
                <div>1</div>
                <div>9</div>
