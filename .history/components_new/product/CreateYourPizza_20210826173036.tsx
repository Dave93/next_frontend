        ...
        >
          ...
          <div className="min-h-screen px-4">
            ...
            <Transition.Child as={Fragment}>
              <div className="bg-gray-100 inline-flex justify-between m-auto my-8 p-6 rounded-3xl transform transition-all w-full">
                <div className="text-center">
                ...
                <div className="w-7/12 bg-white rounded-3xl p-5 text-center">
                  ...
                  <div className="flex space-x-4">
                    <div className="border rounded-3xl w-6/12">
