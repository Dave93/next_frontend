        ...
        >
          <div className="min-h-screen px-4">
            ...
            <Transition.Child as={Fragment}>
              <div className="bg-gray-100 grid grid-cols-12 gap-2 justify-between m-auto my-8 p-6 rounded-3xl transform transition-all container">
                <button ref={completeButtonRef}>Complete order</button>
                  <div className="grid grid-cols-2 gap-2 text-center col-span-3">
                    <div className="rounded-3xl bg-white p-2 h-[174px]">
                ...
                <div className="w-7/12 bg-white rounded-3xl p-5 text-center col-span-6">
