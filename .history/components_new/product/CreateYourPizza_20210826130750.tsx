        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            <Transition.Child as={Fragment}>
              <div className="bg-white grid grid-cols-3 p-6 transform transition-all fixed inset-40 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
                <div>1</div>
                <div>1</div>
                <div>9</div>
              </div>
