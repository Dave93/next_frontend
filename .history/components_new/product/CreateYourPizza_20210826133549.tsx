          ...
          <div className="min-h-screen px-4 text-center">
            ...
            <Transition.Child as={Fragment}>
              <div>
                ...
                <div className="bg-gray-100 grid grid-cols-3 p-6 transform transition-all fixed inset-40 rounded-3xl h-[800px] overflow-auto">
                  <div className="grid grid-cols-3 gap-4">
                    <div className="rounded-3xl bg-white p-2 w-[130px]">
                      <Image src="/pizza_img.png" width="110" height="110" />
                      <div>СЫРНАЯ</div>
                      <div className="text-gray-400">86000 сум</div>
                    </div>
                  </div>
                  <div className="w-[500] bg-white rounded-3xl">
