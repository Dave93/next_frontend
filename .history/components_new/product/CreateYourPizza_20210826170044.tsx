        ...
        >
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            <Transition.Child as={Fragment}>
              <div className="bg-gray-100 flex justify-between m-auto max-w-7xl my-8 p-6 rounded-2xl transform transition-all">
                <div className="">
                ...
                <div className="w-6/12 bg-white rounded-3xl col-span-6">
                  <div className="text-2xl">Пицца Половинки 50/50</div>
                  <div className="text-2xl text-gray-200">Соедини 2 любимых вкуса</div>
