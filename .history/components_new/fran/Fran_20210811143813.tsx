      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-3">
          <div>
            ...
            />
            <div className="text-2xl font-bold my-7">Большой ресторан</div>
            <div className="text-xl">
              <div>Ресторан с полноценным залом и доставкой на дом.</div>
              <div>
                Более 100 посадочных мест, возможно размещение детского игрового
                комплекса или бара с крепким алкоголем
              </div>
              <div> Площадь от 170 м²</div>
              <div> Среднемесячный оборот 150 000 000 сум</div>
            </div>
          </div>
          <div>
            <Image
