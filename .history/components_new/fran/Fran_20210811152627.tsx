        ...
        <div className="text-2xl font-bold">
          Три размера позволяют заказать пиццу на любой случай:
				...
				<div className="grid grid-cols-4">
					<div><Image src="/35s className="grid grid-cols-4"m.png" width="160" height="160"/></div>
					<div><Image src="/32s className="grid grid-cols-4"m.png" width="160" height="160"/></div>
					<div><Image src="/25sm.png" width="160" height="160"/></div>
				</div>
      </div>
      <div className="mb-16">
        <div className="text-5xl text-yellow font-bold mb-10">
