    ...
    <>
      ...
      <div className="mb-16">
        ...
        <div>
          ...
          <div className="text-xl">
            <div className="mb-5">
              ...
              домашней выпечки. Тесто никогда не замораживается, ведь только из
              свежей основы получается вкусная пицца
            </div>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="text-xl">
            <div className="mb-5">
              Производится из свежего молока специально для сети наших пиццерий
            </div>
          </div>
        </div>
      </div>
