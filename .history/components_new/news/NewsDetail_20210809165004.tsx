        ...
        <div className="bg-white rounded-3xl flex p-5">
          ...
          <div className="ml-16 w-[430px]">
            ...
            <div className="mb-12">
              ...
              — 5000 so'm; → soat 22:00 dan 03:00 gacha esa — bepul! Birinchi
              milliy pitsaga qulay !
            </div>
            <div className="text-yellow">Акция дейсвует до 01.08.2021</div>
          </div>
        </div>
      </div>
      <div className="text-2xl mb-4 mt-10">Рекомендуем другие акции</div>
      <div className="bg-white rounded-3xl flex justify-between p-4">
        <div>
          <div className="relative rounded-t-lg overflow-hidden">
            <Image src="/delivery.png" width="350" height="350" />
