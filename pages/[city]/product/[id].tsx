...
export default function ProductPage({
  ...
  const citySlug = chosenCity?.slug || (router.query.city as string) || ''
                  ...
                  {cartQuantity > 0 ? (
                    <>
                      ...
                      <Link
                        href={`/${citySlug}/cart`}
                        prefetch={false}
                        className="bg-yellow focus:outline-none outline-none w-[48px] h-[48px] rounded-full text-white hidden md:flex items-center justify-center"
                      >
