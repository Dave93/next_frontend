...
interface MobileOrdersAppProps {
  channelName: string
}

const MobileOrdersApp: FC<MobileOrdersAppProps> = ({ channelName }) => {
  return (
    <div className="mobile-checkout-wrap">
      <OrdersApp channelName={channelName} isMobile />
      <style jsx global>{`
        /* ===== ROOT ===== */
...
export default MobileOrdersApp
