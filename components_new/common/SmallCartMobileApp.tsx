...
const SmallCartMobile: FC = () => {
  ...
  // password form hooks held for future restoration; only register flagged unused now
  const {
    handleSubmit: handlePasswordSubmit,
    formState: passwordFormState,
  } = useForm<AnyObject>({ mode: 'onChange' })
  ...
  // showPrivacy handler removed during port (was unused) — Wave 7 will wire privacy link UI
